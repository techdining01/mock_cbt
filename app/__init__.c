...
#define __pyx_kp_u_app___init __pyx_string_tab[1]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_app(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_app", 0);
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_app___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{12},{8},{10},{8},{12},{8},{18},{10}};
    /* compression: none (87 bytes) */
static const char bytes[] = "?app.__init____main____module____name____qualname____test__cline_in_tracebacksetdefault";
    PyObject *data = NULL;
