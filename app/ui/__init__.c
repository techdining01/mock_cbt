...
{
    "distutils": {
        "name": "app.ui.__init__",
        "sources": [
            "app\\ui\\__init__.py"
        ]
    },
    "module_name": "app.ui.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__app__ui
#define __PYX_HAVE_API__app__ui
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "app.ui" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "app.ui.__init__"
extern int __pyx_module_is_main_app__ui____init__;
int __pyx_module_is_main_app__ui____init__ = 0;
...
#define __pyx_kp_u_app_ui___init __pyx_string_tab[1]
...
__Pyx_RefNannySetupContext("PyInit_ui", 0);
  ...
  if (__pyx_module_is_main_app__ui____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_app_ui___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "app.ui")) {
      if (unlikely((PyDict_SetItemString(modules, "app.ui", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init app.ui", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init app.ui");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{15},{8},{10},{8},{12},{8},{18},{10}};
    /* compression: none (90 bytes) */
static const char bytes[] = "?app.ui.__init____main____module____name____qualname____test__cline_in_tracebacksetdefault";
    PyObject *data = NULL;
