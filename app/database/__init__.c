...
{
    "distutils": {
        "name": "app.database.__init__",
        "sources": [
            "app\\database\\__init__.py"
        ]
    },
    "module_name": "app.database.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__app__database
#define __PYX_HAVE_API__app__database
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "app.database" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "app.database.__init__"
extern int __pyx_module_is_main_app__database____init__;
int __pyx_module_is_main_app__database____init__ = 0;

/* Implementation of "app.database" */
...
#define __pyx_kp_u_app_database___init __pyx_string_tab[2]
#define __pyx_n_u_Base __pyx_string_tab[3]
#define __pyx_n_u_DATABASE_PATH __pyx_string_tab[4]
#define __pyx_n_u_DATABASE_URL __pyx_string_tab[5]
#define __pyx_n_u_SessionLocal __pyx_string_tab[6]
...
#define __pyx_n_u_app_database_database __pyx_string_tab[13]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[14]
#define __pyx_n_u_engine __pyx_string_tab[15]
#define __pyx_n_u_init_database __pyx_string_tab[16]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_database(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_database", 0);
  ...
  if (__pyx_module_is_main_app__database____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_app_database___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "app.database")) {
      if (unlikely((PyDict_SetItemString(modules, "app.database", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_Base,__pyx_mstate_global->__pyx_n_u_DATABASE_PATH,__pyx_mstate_global->__pyx_n_u_DATABASE_URL,__pyx_mstate_global->__pyx_n_u_SessionLocal,__pyx_mstate_global->__pyx_n_u_engine,__pyx_mstate_global->__pyx_n_u_init_database};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_app_database_database, __pyx_imported_names, 6, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
...
*/
  {
    PyObject* __pyx_temp[6] = {__pyx_mstate_global->__pyx_n_u_Base, __pyx_mstate_global->__pyx_n_u_DATABASE_PATH, __pyx_mstate_global->__pyx_n_u_DATABASE_URL, __pyx_mstate_global->__pyx_n_u_SessionLocal, __pyx_mstate_global->__pyx_n_u_engine, __pyx_mstate_global->__pyx_n_u_init_database};
    __pyx_t_2 = __Pyx_PyList_FromArray(__pyx_temp, 6); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
  }
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init app.database", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init app.database");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{1},{21},{4},{13},{12},{12},{7},{8},{10},{8},{12},{8},{21},{18},{6},{13},{10}};
    /* compression: none (185 bytes) */
static const char bytes[] = ".?app.database.__init__BaseDATABASE_PATHDATABASE_URLSessionLocal__all____main____module____name____qualname____test__app.database.databasecline_in_tracebackengineinit_databasesetdefault";
    PyObject *data = NULL;
