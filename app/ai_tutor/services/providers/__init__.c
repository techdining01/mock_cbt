...
{
    "distutils": {
        "name": "providers.__init__",
        "sources": [
            "app\\ai_tutor\\services\\providers\\__init__.py"
        ]
    },
    "module_name": "providers.__init__"
}
END: Cython Metadata */
...
#define __Pyx_MODULE_NAME "providers.__init__"
extern int __pyx_module_is_main_providers____init__;
int __pyx_module_is_main_providers____init__ = 0;
...
#define __pyx_kp_u_providers___init __pyx_string_tab[1]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_providers(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_providers", 0);
  ...
  if (__pyx_module_is_main_providers____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_providers___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "providers")) {
      if (unlikely((PyDict_SetItemString(modules, "providers", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
static const char bytes[] = "?providers.__init____main____module____name____qualname____test__cline_in_tracebacksetdefault";
    PyObject *data = NULL;
