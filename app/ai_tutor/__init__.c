...
{
    "distutils": {
        "name": "app.ai_tutor.__init__",
        "sources": [
            "app\\ai_tutor\\__init__.py"
        ]
    },
    "module_name": "app.ai_tutor.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__app__ai_tutor
#define __PYX_HAVE_API__app__ai_tutor
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "app.ai_tutor" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "app.ai_tutor.__init__"
extern int __pyx_module_is_main_app__ai_tutor____init__;
int __pyx_module_is_main_app__ai_tutor____init__ = 0;

/* Implementation of "app.ai_tutor" */
...
#define __pyx_kp_u_app_ai_tutor___init __pyx_string_tab[1]
...
static int __pyx_pymod_exec_ai_tutor(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ai_tutor},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_ai_tutor(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_ai_tutor(); }
#endif
__Pyx_PyMODINIT_FUNC PyInit_ai_tutor(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ai_tutor(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ai_tutor' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "ai_tutor" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_ai_tutor", 0);
  ...
  if (__pyx_module_is_main_app__ai_tutor____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_app_ai_tutor___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "app.ai_tutor")) {
      if (unlikely((PyDict_SetItemString(modules, "app.ai_tutor", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init app.ai_tutor", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init app.ai_tutor");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{21},{8},{10},{8},{12},{8},{18},{10}};
    /* compression: none (96 bytes) */
static const char bytes[] = "?app.ai_tutor.__init____main____module____name____qualname____test__cline_in_tracebacksetdefault";
    PyObject *data = NULL;
